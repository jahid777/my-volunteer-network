  ...
  return (
    <div className="row" style={{ marginTop: "15px" }}>
      <div className="col-md-4">
        <img
          style={{ height: "80px", marginLeft: "35px", marginBottom: "25px" }}
          src={logo}
          alt=""
        />{" "}
        <br />
        <div
          style={activeRegList ? activeStyle : { cursor: "pointer" }}
          onClick={(e) => handleRegList(e)}
        >
          <img
            style={{ margin: "35px", marginTop: "35px", height: "35px" }}
            src={volunteerList}
            alt=""
          />
        ...
        <br />
        <div
          style={activeEventForm ? activeStyle : { cursor: "pointer" }}
          onClick={(e) => handleEventForm(e)}
        >
          <img
            style={{ margin: "35px", marginTop: "25px", height: "35px" }}
            src={addEvent}
            alt=""
          />
          <span>Add event</span>
      ...
      <div className="col-md-8">
        ...
        <h3 style={{ marginTop: "35px" }}>
          {activeRegList ? "Volunteer register list" : "Event"}
        </h3>
        <div
          style={{
